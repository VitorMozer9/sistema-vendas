...
begin
   ...
   try
      try
        ...
        begin
           TMessageUtil.Informacao('Usuario cadastrado com sucesso');
         ...
         begin
            Raise Exception.Create(
               'Falha ao incluir os dados de Usuario[View]: '#13 +
               e.Message);
         end;
      end;
   finally
...
begin
   ...
   begin
      TMessageUtil.Alerta(
         'A senha do Usuário não pode ficar em branco.  ');
   ...
   begin
      TMessageUtil.Alerta(
         'O nome do usuário não pode ficar em branco.  ');
...
begin
   try
    Result := False;
      ...
      begin
         TMessageUtil.Alerta('Nenhum usuáro encontrado');
...
begin
   try
      ...
      begin
         raise Exception.Create(
            'Falha ao alterar os dados do usuário [View]: '#13+
            e.Message);
      end;
   end;
end;
